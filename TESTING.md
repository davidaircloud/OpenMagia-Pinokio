...
## Current release compatibility — 2026-09-12

- OpenMagia `04614ec` passes all 218 application regression tests.
- Static Skills-page poster thumbnails and concise OpenMagia attribution for music workflows were verified in the application release.
